...
class InventoryMovementList extends StatefulWidget {
  ...
  @override
  State<InventoryMovementList> createState() => _InventoryMovementListState();
}

class _InventoryMovementListState extends State<InventoryMovementList> {
  int counter = 0;
  int keyCode = 0;
    ...
    return MultiBlocProvider(
      providers: [
        BlocProvider<InventoryBloc>(
            create: (context) => InventoryBloc(FirestoreInventoryService(),
                "Inventory", widget.sparePartId, widget.workShopId)
              ..add(LoadInventoryByTypeAndSparePart())),
      ],
      child: Scaffold(
        appBar: AppBar(
          leading: IconButton(
          ...
          title: Text(
            'Movimientos de inventario ${widget.sparePartName}',
